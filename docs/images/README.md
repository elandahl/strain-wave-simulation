...
| `published_fig2_scirep_2022.png` | **Next paper target.** Figure 2 of Jo et al. (Cr/Si substrate). The Cr/Si strain case is the next strain-side target for Fig. 2 reproduction. | Jo et al., Sci. Rep. **12**, 16606 (2022) | Reproduced under **CC BY 4.0**; attribution required. Also copied to the xrd and thermo `docs/images/` folders. |
